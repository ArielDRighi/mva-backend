...
import { ChemicalToiletsModule } from '../chemical_toilets/chemical_toilets.module'; // Importar este módulo

@Module({
  imports: [
    TypeOrmModule.forFeature([ToiletMaintenance, ChemicalToilet]),
